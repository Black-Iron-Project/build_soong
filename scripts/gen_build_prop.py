...
def parse_args():
  ...
  config["BlackironDesc"] = config["BuildDesc"]
  config["BlackironDevice"] = config["DeviceName"]
...
def generate_build_info(args):
  ...
  if config["BuildVariant"] == "user":
    ...
    print(f"ro.build.display.id?={config['BlackironDesc']}")
  ...
  print(f"ro.blackiron.device={config['BlackironDevice']}")
